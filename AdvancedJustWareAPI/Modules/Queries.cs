...
namespace AdvancedJustWareAPI.Modules
{
	...
	public class Queries
	{
		...
		{
			// Using single quotes to qualify strings will fail
			try
			{
			...
			// Always use double quotes event though it is a pain to escape
		...
		{
			// Setup a case with several events
		...
		public void QueryingCollections()
		{
			...
			// Setup reusable query to restrict to names created above
		...
		public void OrderBy()
		{
			...
			// Query with no order by specified.  Gives back insert order
			...
			// Query with order by first name (defaults to ascending)
			...
			// Query with order by first name descending
